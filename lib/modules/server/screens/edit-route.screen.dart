...
class EditRouteScreen extends ConsumerWidget implements IsScreen {
  @override
  ...
  @override
  String get routePath => "route/:routeId/edit";

  @override
  String get title => "Editing Route";

  @override
  String get uniqueName => 'edit-route';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: goRouterState?.pathParameters['serverId'] != null &&
              goRouterState?.pathParameters['routeId'] != null
          ? RouteCrud(
              goRouterState!.pathParameters['serverId']!,
              routeId: goRouterState?.pathParameters['routeId'],
            )
          : const Text('Missing Params'),
    );
  }
}
